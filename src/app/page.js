...
import { userLogin } from "@/store/reducer/common/UserLoginReducer";
  ...
  const onSubmit = (data) => {
    ...
    dispatch(userLogin(data))
      .then((response) => {
        ...
        const { token, isTeacher } = responseData;

        // Store the token and teamLead status in the local storage
        localStorage.setItem("token", token);
        localStorage.setItem("teacher", isTeacher);
              ...
              <div className=" px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-28">
                <div className="mr-auto place-self-center lg:col-span-7">
                  <h1 className="max-w-2xl mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-5xl text-white">
                    Join Jamimasjid Noorani Online Learning Now!
                  </h1>
