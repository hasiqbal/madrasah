...
const Register = () => {
  ...
  const [loginVal, setLoginVal] = useState("Register");
              ...
              <div className=" px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-28">
                <div className="mr-auto place-self-center lg:col-span-7">
                  ...
                  <p className="max-w-2xl mb-6 font-light text-gray-300 lg:mb-8 md:text-lg lg:text-xl ">
                    Unlock administrative privileges at Jamimasjid Noorani
                    Online Learning. Register now to contribute to the
                    educational ecosystem, manage courses, and shape a thriving
                    community. Join us in empowering online Islamic education!
                  </p>
